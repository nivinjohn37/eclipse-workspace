 ...
 * 
 */
sap.ui.unified.calendar.Month.prototype.weekNumberSelect = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.unified.calendar.Month.prototype.attachWeekNumberSelect = function(oData,fnFunction,oListener) { return new sap.ui.unified.calendar.Month(); };
 ...
 * 
 */
sap.ui.unified.calendar.Month.prototype.detachWeekNumberSelect = function(fnFunction,oListener) { return new sap.ui.unified.calendar.Month(); };
 ...
 * 
 */
sap.ui.unified.calendar.Month.prototype.fireWeekNumberSelect = function(mParameters) { return false; };
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover = function(sId,mSettings) {};
/**
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.change = function(oControlEvent) {  };
 ...
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ui.unified.ColorPickerPopover</code> itself.
 * 
 * Fired when the submit button of the popover is clicked.
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ui.unified.ColorPickerPopover</code> itself
 * 
 * @returns {sap.ui.unified.ColorPickerPopover} Reference to <code>this</code> in order to allow method chaining
 * @public
 * @since 1.60.0
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.attachChange = function(oData,fnFunction,oListener) { return new sap.ui.unified.ColorPickerPopover(); };
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.close = function() { return new sap.ui.core.Control(); };
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.detachChange = function(fnFunction,oListener) { return new sap.ui.unified.ColorPickerPopover(); };

/**
 * Creates a new subclass of class sap.ui.unified.ColorPickerPopover with name <code>sClassName</code>
 * and enriches it with the information contained in <code>oClassInfo</code>.
 * 
 * <code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ui.core.Control.extend}.
 * 
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover.extend = function(sClassName,oClassInfo,FNMetaImpl) { return function() {}; };
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.fireChange = function(mParameters) { return new sap.ui.unified.ColorPickerPopover(); };
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.getColorString = function() { return ""; };
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.getDisplayMode = function() { return new sap.ui.unified.ColorPickerDisplayMode(); };
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover.getMetadata = function() { return new sap.ui.base.Metadata(); };
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.getMode = function() { return new sap.ui.unified.ColorPickerMode(); };
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.openBy = function(openBy) { return null; };
 ...
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.setColorString = function(sColorString) { return new sap.ui.unified.ColorPickerPopover(); };
 ...
 * 
 * Default value is <code>Default</code>.
 * @param {sap.ui.unified.ColorPickerDisplayMode} sDisplayMode New value for property <code>displayMode</code>
 * @returns {sap.ui.unified.ColorPickerPopover} Reference to <code>this</code> in order to allow method chaining
 * @since 1.60.0
 * 
 * @public
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.setDisplayMode = function(sDisplayMode) { return new sap.ui.unified.ColorPickerPopover(); };
 ...
 * 
 * Default value is <code>HSV</code>.
 * @param {sap.ui.unified.ColorPickerMode} sMode New value for property <code>mode</code>
 * @returns {sap.ui.unified.ColorPickerPopover} Reference to <code>this</code> in order to allow method chaining
 * @since 1.60.0
 * 
 * @public
 * 
 */
sap.ui.unified.ColorPickerPopover.prototype.setMode = function(sMode) { return new sap.ui.unified.ColorPickerPopover(); };
 ...
 * 
 */
sap.ui.unified.MenuItem.prototype.addAriaLabelledBy = function(vAriaLabelledBy) { return new sap.ui.unified.MenuItem(); };
 ...
 * 
 */
sap.ui.unified.MenuItem.prototype.getAriaLabelledBy = function() { return new Array(); };
 ...
 * 
 */
sap.ui.unified.MenuItem.prototype.removeAllAriaLabelledBy = function() { return new Array(); };
 ...
 * 
 */
sap.ui.unified.MenuItem.prototype.removeAriaLabelledBy = function(vAriaLabelledBy) { return new sap.ui.core.ID(); };
